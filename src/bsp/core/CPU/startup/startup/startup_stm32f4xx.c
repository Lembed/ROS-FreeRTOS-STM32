...
static void DefaultHardFault_Handler(void);
...
#pragma weak HardFault_Handler = DefaultHardFault_Handler
...
//Al #pragma weak ETH_IRQHandler = Default_Handler
...
void prvGetRegistersFromStack(unsigned long *pulFaultStackAddress )
{
